package com.jayden.user.websocket;

import com.jayden.websocket.config.WebSocketCheckConfig;
...
@ServerEndpoint(value = "/jayden/socket", configurator = WebSocketCheckConfig.class)
@Component
